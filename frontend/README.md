...
* [`src/frontend/styles.cljs`](src/frontend/styles.cljs): CSS compilation source file (ClojureScript,
[Garden](https://github.com/noprompt/garden))
* [`src/frontend/`](src/frontend/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/frontend/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `frontend` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/frontend/config.cljs) defaults to `true` in
